import { LoadConfigResult, LoadConfigResult as LoadConfigResult$1, LoadConfigSource } from "unconfig";
import MagicString from "magic-string";

//#region ../core/src/utils/countable-set.d.ts
...
//#endregion
//#region ../core/src/utils/events.d.ts
...
//#endregion
//#region ../core/src/utils/map.d.ts
...
//#endregion
//#region ../core/src/generator.d.ts
...
interface UnocssPluginContext<Config extends UserConfig = UserConfig> {
   ...
   */
  ready: Promise<LoadConfigResult$1<Config>>;
  /**
  ...
  reloadConfig: () => Promise<LoadConfigResult$1<Config>>;
  getConfig: () => Promise<Config>;
  onReload: (fn: () => void) => void;
  invalidate: () => void;
  onInvalidate: (fn: () => void) => void;
  root: string;
  updateRoot: (root: string) => Promise<LoadConfigResult$1<Config>>;
...
declare function loadConfig<U$1 extends UserConfig>(cwd?: string, configOrPath?: string | U$1, extraConfigSources?: LoadConfigSource[], defaults?: UserConfigDefaults): Promise<LoadConfigResult<U$1>>;
/**
 ...
 */
declare function createRecoveryConfigLoader<U$1 extends UserConfig>(): (cwd?: string, configOrPath?: string | U$1, extraConfigSources?: LoadConfigSource[], defaults?: UserConfigDefaults) => Promise<LoadConfigResult<U$1>>;
//#endregion
